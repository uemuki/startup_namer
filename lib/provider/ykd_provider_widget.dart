...
///
/// 方便数据初始化
class YKDProviderWidget<T extends ChangeNotifier> extends StatefulWidget {
...
class _ProviderWidgetState<T extends ChangeNotifier>
    extends State<YKDProviderWidget<T>> {
  T model;
...
class YKDProviderWidget2<A extends ChangeNotifier, B extends ChangeNotifier>
...
class _ProviderWidgetState2<A extends ChangeNotifier, B extends ChangeNotifier>
    extends State<YKDProviderWidget2<A, B>> {
  A model1;
  B model2;
